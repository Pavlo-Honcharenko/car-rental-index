 ...
 */
    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker-start]")) {
            const start = datepicker_min("[data-datepicker-start]", {
            ...
            modules_flsModules.datepicker = start;
        }
        if (document.querySelector("[data-datepicker-end]")) {
            const end = datepicker_min("[data-datepicker-end]", {
                customDays: [ "S", "M", "T", "W", "TH", "F", "S" ],
                customMonths: [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ],
                overlayButton: "Confirm",
                overlayPlaceholder: "Enter a 4-digit year",
            ...
            modules_flsModules.datepicker = end;
        }
        ...
        if (priceSlider) {
            ...
            var valuemax = priceEnd.getAttribute("aria-valuemax");
            if (valuemax) ; else valuemax = 5e3;
            ...
            function setPriceValues() {
                let priceStartValue;
                let priceEndValue;
                if ("" != priceStart.value) priceStartValue = Math.round(priceStart.value);
                if ("" != priceEnd.value) priceEndValue = Math.round(priceEnd.value);
                priceSlider.noUiSlider.set([ priceStartValue, priceEndValue ]);
            }
            var inputPriceStart = document.getElementById("price-start");
            var inputPriceEnd = document.getElementById("price-end");
            if ("" != inputPriceStart.value && "" != inputPriceEnd.value) priceSlider.noUiSlider.set([ Math.round(inputPriceStart.value), Math.round(inputPriceEnd.value) ]);
            priceSlider.noUiSlider.on("update", (function(values, handle) {
                var value = Math.round(values[handle]);
                if (handle) inputPriceEnd.value = Math.round(value); else inputPriceStart.value = Math.round(value);
            }));
            inputPriceStart.addEventListener("change", (function() {
                priceSlider.noUiSlider.set([ null, this.value ]);
            }));
            inputPriceEnd.addEventListener("change", (function() {
                priceSlider.noUiSlider.set([ null, Math.round(this.value) ]);
            }));
            const resetButton = document.getElementById("reset");
            if (resetButton) resetButton.onclick = e => {
                priceSlider.noUiSlider.set([ priceStart.defaultValue, priceEnd.defaultValue ]);
            };
        }
        ...
        const eyeClosed1 = document.getElementById("eye-closed1");
        const eyeOpen1 = document.getElementById("eye-open1");
        function showPassword1() {
            if ("undefined" !== typeof inputPassword1) inputPassword1.type = "text";
            eyeClosed1.style.display = "none";
            eyeOpen1.style.display = "block";
        }
        function hidePassword1() {
            if ("undefined" !== typeof inputPassword1) inputPassword1.type = "password";
            eyeClosed1.style.display = "block";
            eyeOpen1.style.display = "none";
        }
        if (document.getElementById("eye-closed1")) eyeClosed1.addEventListener("click", showPassword1);
        if (document.getElementById("eye-open1")) eyeOpen1.addEventListener("click", hidePassword1);
        const inputPassword2 = document.getElementById("password2");
        const eyeClosed2 = document.getElementById("eye-closed2");
        const eyeOpen2 = document.getElementById("eye-open2");
        function showPassword2() {
            if ("undefined" !== typeof inputPassword2) inputPassword2.type = "text";
            eyeClosed2.style.display = "none";
            eyeOpen2.style.display = "block";
        }
        function hidePassword2() {
            if ("undefined" !== typeof inputPassword2) inputPassword2.type = "password";
            eyeClosed2.style.display = "block";
            eyeOpen2.style.display = "none";
        }
        if (document.getElementById("eye-closed2")) eyeClosed2.addEventListener("click", showPassword2);
        if (document.getElementById("eye-open2")) eyeOpen2.addEventListener("click", hidePassword2);
        if (document.documentElement.clientWidth < 768) if (document.querySelector(".button-filters")) {
            ...
            filtersButton.addEventListener("click", (function(e) {
                filtersButton.classList.toggle("open");
                filtersBody.classList.toggle("open");
            }));
        }
        if (document.querySelector(".catalog__row")) {
            let targetBlockPC = document.querySelector(".selected-options-pc");
            let targetBlockMobile = document.querySelector(".selected-options-mobile");
            let selectedElements = new Array;
            let applyButton = document.querySelector(".buttons__button_apply");
            let resetButton = document.getElementById("reset");
            let clearAll = document.querySelector(".clear-all-link");
            let selectedOptions = "";
            function addToSelectedElementsPC(selectedElements) {
                let myHTML = "";
                for (let index = 0; index < selectedElements.length; index++) {
                    let element = selectedElements[index];
                    myHTML = myHTML + "<span>" + element + '<button item-content="' + element + '" class="delete-button"></button></span>';
                }
                targetBlockPC.innerHTML = myHTML;
            }
            function addToSelectedElementsMobile(selectedElements) {
                let myHTML = "";
                for (let index = 0; index < selectedElements.length; index++) {
                    let element = selectedElements[index];
                    myHTML = myHTML + "<span>" + element + '<button item-content="' + element + '" class="delete-button"></button></span>';
                }
                targetBlockMobile.innerHTML = myHTML;
            }
            function requestAJAX(selectedOptions) {}
            const section = document.querySelector(".catalog__row");
            section.addEventListener("click", (function(e) {
                let targetItem = e.target;
                if (targetItem.closest(".filter-element")) {
                    targetItem.closest(".filter-element").classList.toggle("filter-element-selected");
                    let inArray = selectedElements.indexOf(targetItem.value);
                    if (-1 == inArray) {
                        selectedElements.push(targetItem.value);
                        if ("colors" == targetItem.name) {
                            const colors = document.querySelectorAll(".options__input_colors");
                            for (let index = 0; index < colors.length; index++) {
                                const element = colors[index];
                                if (element.value != targetItem.value) {
                                    let inArray = selectedElements.indexOf(element.value);
                                    if (-1 != inArray) selectedElements.splice(inArray, 1);
                                }
                            }
                        }
                    } else if ("colors" != targetItem.name) selectedElements.splice(inArray, 1);
                    addToSelectedElementsPC(selectedElements);
                    addToSelectedElementsMobile(selectedElements);
                }
                requestAJAX(selectedOptions);
            }));
            function addPrice() {
                let priceFrom = document.getElementById("price-start");
                let priceTo = document.getElementById("price-end");
                let priceValues = document.getElementById("price-values");
                let myHTML = "";
                myHTML = '<span id="price1">' + priceFrom.value + '</span><span id="price2">' + priceTo.value + "</span>";
                priceValues.innerHTML = myHTML;
            }
            addPrice();
            ...
            clearAll.addEventListener("click", (function(e) {
                let options = document.querySelectorAll(".filter-element-selected");
                for (let index = 0; index < options.length; index++) {
                    let deleteItem = document.getElementById(options[index].id);
                    deleteItem.checked = false;
                    deleteItem.classList.remove("filter-element-selected");
                }
                selectedElements = [];
                addToSelectedElementsPC(selectedElements);
                addToSelectedElementsMobile(selectedElements);
            ...
            targetBlockPC.addEventListener("click", (function(e) {
                let targetItem = e.target;
                let targetItemValue = targetItem.parentElement.innerText;
                let inArray = selectedElements.indexOf(targetItemValue);
                if (-1 != inArray) selectedElements.splice(inArray, 1);
                addToSelectedElementsPC(selectedElements);
                let options = document.querySelectorAll(".filter-element-selected");
                for (let index = 0; index < options.length; index++) if (options[index].value == targetItemValue) {
                    let deleteItem = document.getElementById(options[index].id);
                    deleteItem.checked = false;
                    deleteItem.classList.remove("filter-element-selected");
                }
            ...
            targetBlockMobile.addEventListener("click", (function(e) {
                let targetItem = e.target;
                let targetItemValue = targetItem.parentElement.innerText;
                let inArray = selectedElements.indexOf(targetItemValue);
                if (-1 != inArray) selectedElements.splice(inArray, 1);
